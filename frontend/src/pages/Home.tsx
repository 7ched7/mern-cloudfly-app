...
export default function Home() {
    ...
    return (
        <div className="min-h-screendefault flex flex-col items-center justify-center overflow-hidden relative">
            <Animate className="flex-1 w-[1200px] flex flex-col lg:flex-row items-center justify-center gap-8 px-12">
                <img
                    src={logo}
                    alt="My Files"
                    width={500}
                    className="w-72 lg:w-[500px] select-none pointer-events-none"
                />
